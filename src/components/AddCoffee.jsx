...
const AddCoffee = () => {
    ...
    const handleAddCoffee = (event) =>{
        ...
        fetch('https://expresso-premium-server.vercel.app/coffee',{
            method: 'POST',
            headers: {
                        ...
                        <div className=" lg:flex lg:gap-3">
                            ...
                            <div className="w-full">
                                ...
                                <div className="relative text-sm mt-0">
                                    ...
                                    <input
                                        className="peer/name text-black block w-full rounded-md border border-blue-400 bg-inherit p-2.5 shadow-lg outline-none"
                                        type="text"
                                        placeholder=""
